...
class WebSportsNews extends StatefulWidget {
  final int newsIndex;
  const WebSportsNews({super.key, required this.newsIndex});

  @override
  State<WebSportsNews> createState() => _WebSportsNews();
}

class _WebSportsNews extends State<WebSportsNews> {
  List news = [];
