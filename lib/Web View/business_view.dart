...
class WebBusinessNews extends StatefulWidget {
  final int newsIndex;
  const WebBusinessNews({super.key, required this.newsIndex});

  @override
  State<WebBusinessNews> createState() => _WebBusinessNews();
}

class _WebBusinessNews extends State<WebBusinessNews> {
  List news = [];
